...
class VideosViewController: BaseViewController {
    ...
    var videoUrl = [String]()//"http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4","http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4"
